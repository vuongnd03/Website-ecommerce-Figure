...
export default function DragonBall(){
    ...
    useEffect(()=>{
        const fetchProduct = async ()=>{
            try{
                const response = await axios.get("https://localhost:7048/api/Products/Hottrend/dragon%20ball");
    ...
    <div className={styles.Onepice}><button><h1>Dragon Ball</h1></button></div>

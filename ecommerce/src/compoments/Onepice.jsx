...
export default function Onepice(){
    const navigate = useNavigate();
    const [products, setProducts] = useState([]);
    useEffect(()=>{
        const fetchProduct = async ()=>{
            try{
                const response = await axios.get("https://localhost:7048/api/Products/Hottrend/one%20piece");
    ...
    <div className={styles.Onepice}><button><h1>One Piece</h1></button></div>
